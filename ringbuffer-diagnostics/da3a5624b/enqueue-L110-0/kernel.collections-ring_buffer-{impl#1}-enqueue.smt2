...
(var $k1 (int int int int int bool)) ;; orig: $k1
(var $k2 (int int int int int bool)) ;; orig: $k2
                  ...
                  (and
                   ...
                   (forall ((_$ int) ((!= (tuple3$0 reftgen$old$1) 0)))
                    (and
                     ...
                     (forall ((a10 int) (true))
                      (forall ((a11 int) ((= a11 (tuple3$0 reftgen$old$1))))
                       (forall ((a12 int) ((= a12 (tuple3$1 reftgen$old$1))))
                        (forall ((a13 int) ((= a13 (tuple3$2 reftgen$old$1))))
                     ...
                     (tag ((if (= (tuple3$1 reftgen$old$1) (mod (+ (tuple3$2 reftgen$old$1) 1) (tuple3$0 reftgen$old$1))) (and (= (tuple3$1 reftgen$old$1) (tuple3$1 reftgen$old$1)) (= (tuple3$2 reftgen$old$1) (mod (+ (tuple3$2 reftgen$old$1) 1) (tuple3$0 reftgen$old$1)))) true)) "6")
                     (forall ((a14 int) (true))
                      (forall ((a15 int) ((= a15 (tuple3$0 reftgen$old$1))))
                       (forall ((a16 int) ((= a16 (tuple3$1 reftgen$old$1))))
                        (forall ((a17 int) ((= a17 (tuple3$2 reftgen$old$1))))
                         ($k2 a14 a15 a16 a17 a0 a5)))))))))))))))))))
       (forall ((_$ int) (a5))
        (and
         (tag ((= false (!= (tuple3$1 reftgen$old$1) (mod (+ (tuple3$2 reftgen$old$1) 1) (tuple3$0 reftgen$old$1))))) "7")
         (tag ((if (= (tuple3$1 reftgen$old$1) (mod (+ (tuple3$2 reftgen$old$1) 1) (tuple3$0 reftgen$old$1))) (and (= (tuple3$1 reftgen$old$1) (tuple3$1 reftgen$old$1)) (= (tuple3$2 reftgen$old$1) (tuple3$2 reftgen$old$1))) true)) "8"))))))))))
