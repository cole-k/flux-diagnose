;; Tag 0: Ret at 109:1: 109:2
;; Tag 1: Call at 100:28: 100:31
;; Tag 2: Call at 100:17: 100:37
;; Tag 3: Call at 101:28: 101:31
;; Tag 4: Call at 101:36: 101:39
;; Tag 5: Call at 101:9: 101:40
;; Tag 6: Call at 102:17: 102:20
                    ...
                    (forall ((a18 int) (true))
                     (forall ((a19 int) (true))
                      (forall ((_$ int) ((<= 0 a19)))
                       (and
                        (forall ((a20 int) (true))
                         (tag ((= a20 reftgen$n$0)) "0"))
                        (tag ((= a19 reftgen$k$1)) "0"))))))
                   (forall ((_$ int) ((< a14 a0)))
                    (and
                     (forall ((a21 int) (true))
