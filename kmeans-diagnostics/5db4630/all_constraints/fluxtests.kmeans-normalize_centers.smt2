;; Tag 0: Call at 85:23: 85:26
;; Tag 1: Call at 85:35: 85:38
                ...
                (forall ((a11 int) (true))
                 (forall ((_$ int) ($k4 a11 a0 a1 a2 a7 a8))
                  (forall ((_$ int) ((>= a11 0)))
                   (and
                    (forall ((a12 int) (true))
                     ($k3 a12 a0 a1 a2 a7 a8))
                    (forall ((a13 int) (true))
                     (and
                      (forall ((a14 int) ((= a14 (+ a7 1))))
                       ($k1 a14 a0 a1 a2))
                      (forall ((a15 int) (true))
                       (forall ((_$ int) ($k2 a15 a7 a0 a1 a2))
                        (forall ((a16 int) ((= a16 (+ a7 1))))
                         ($k2 a15 a16 a0 a1 a2))))
                      (forall ((a17 int) (true))
                       (forall ((_$ int) ($k2 a17 a18 a0 a1 a2))
                        (forall ((a18 int) ((= a18 (+ a7 1))))
                         ($k2 a17 a7 a0 a1 a2))))))))))))))))))))))))))
